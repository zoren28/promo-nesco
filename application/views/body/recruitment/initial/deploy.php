		...
		<div class="col-sm-12" style="padding-right:5px">
			<div class="panel panel-default">		
				<div class="panel-body">
					<?php
					$result_applicants = $this->initial_model->deploy_applicants();
					?>
							...
							<tbody>
								...
								foreach ($result_applicants as $i) { ?>
									<tr>
										...
										<td><?= $i['position'] ?></td>
										<td><?= $i['date_time'] ?></td>
										<td><button id="<?=$i['app_code']."|".$i['app_id'] ?>" type="button" class="btn btn-primary btn-sm deploy">Deploy</button></td>
									</tr><?php } ?>
							</tbody>
						</table>
				</div>
